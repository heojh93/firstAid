...
class BookData : NSObject{
    ...
    init(bookName:String, bookWriter:String, bookImage:String, bookId: Int){
        self.bookId = bookId
        self.bookName = bookName
        self.bookWriter = bookWriter
        self.bookImage = bookImage
    }
    init(bookName:String, bookWriter:String, bookId: Int){
        self.bookId = bookId
        self.bookName = bookName
        self.bookWriter = bookWriter
    }
...
class Question : BookData{
    ...
    init(book:BookData, chapter:Int, number questionNumber:Int, tag questionTag:String, answer numberOfAnswer:Int, questionId:Int){
        self.questionId = questionId
        self.chapter = chapter
        self.questionNumber = questionNumber
        self.questionTag = questionTag
        self.numberOfAnswer = numberOfAnswer
        super.init(bookName: book.bookName,bookWriter: book.bookWriter, bookId: book.bookId)
    }
...
let algorithm = BookData(bookName: "Algorithm",bookWriter: "abc", bookId:300)
let automata = BookData(bookName: "Automata",bookWriter: "aaa", bookId:500)
let datastructure = BookData(bookName: "DataStructure",bookWriter: "ddd", bookId:200)
