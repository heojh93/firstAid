...
public protocol SearchTagViewDataSource : NSObjectProtocol {
    func searchPropertyName() -> String
}

class QuestionTable: UITableView {
    ...
    var searchDataSource: SearchTagViewDataSource?
...
extension QuestionTable: UISearchResultsUpdating {
